...
class LaporanController extends Controller
{
    ...
    public function laporanBulananRAB(Request $request)
    {
        ...
        if ($request->get('filter')) {
            ...
            $pendapatan = transaksi::whereIn('kategori', ['Pendapatan', 'Pendapatan Lain', 'Kelebihan Tanah'])->where('proyek_id', proyekId())->whereBetween('tanggal', [$start, $end])->get();
    ...
    public function laporanTahunan(Request $request)
    {
        ...
        if ($request->get('filter')) {
            ...
            $tahuniniStart = Carbon::parse($request->start)->firstOfYear()->isoFormat('YYYY-MM-DD');
            $tahuniniEnd = Carbon::parse($request->end)->endOfYear()->isoFormat('YYYY-MM-DD');
            $pendapatan = transaksi::whereIn('kategori', ['Pendapatan', 'Pendapatan Lain'])->where('proyek_id', proyekId())->whereBetween('tanggal', [$start, $end])->get();
