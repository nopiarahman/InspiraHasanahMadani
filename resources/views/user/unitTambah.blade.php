...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
      <form action="{{route('transferCicilanSimpan')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-group row mb-4">
          ...
          <div class="col-sm-12 col-md-7">
            ...
            <input type="date" readonly class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{Carbon\carbon::now()->isoFormat('YYYY-MM-DD')}}" >
            @error('tanggal')
