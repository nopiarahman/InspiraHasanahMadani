                        ...
                        <form action="{{ route('cicilanKavlingSimpan') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="input-group col-sm-12 col-md-7">
                                    ...
                                    <input type="text" readonly class="akadDp form-control"
                                        value="{{ $id->sisaKewajiban }} " id="totalDiskon">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="input-group col-sm-12 col-md-7">
                                    ...
                                    <input type="text" readonly class="akadDp form-control"
                                        value="{{ number_format($cicilanPerBulan) }} " id="totalDiskon">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                            ...
                            <td>
                                ...
                                @if (auth()->user()->role == 'admin' || auth()->user()->role == 'projectmanager' || auth()->user()->role == 'kasir')
                                    ...
                                    <button type="button" class="btn btn-sm btn-white text-info border-info"
                                        ...
                                        {{-- data-tp="{{formatTanggal($cicilanUnit->tanggal)}}" --}} data-jumlah="{{ $cicilanUnit->jumlah }}"
