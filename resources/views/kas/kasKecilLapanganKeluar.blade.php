...
<div class="section-header sticky-top">
  <div class="container">
    ...
    <div class="section-header">
      <a href="{{route('kasKecilLapangan')}}"  class="btn btn-primary  ">Masuk</a>
      <a href="{{route('kasKecilLapanganKeluar')}}" class="btn btn-primary ml-2 disabled">Keluar</a>
  </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4>Tambah Transaksi Keluar Kas Kecil Lapangan</h4>
          </div>
          <div class="card-body">
          <form action="{{route('kasKecilLapanganKeluarSimpan')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group row mb-4">
  ...
  @endif
    <div class="card">
      ...
      <div class="card-body">
         {{-- filter --}}
      <form action="{{route('kasKecilLapanganKeluar')}}" method="get" enctype="multipart/form-data">
