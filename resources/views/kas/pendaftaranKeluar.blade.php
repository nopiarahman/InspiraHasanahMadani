...
@section('content')
    ...
    @if (auth()->user()->role == 'admin' || auth()->user()->role == 'kasir' || auth()->user()->role == 'projectmanager')
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('kasPendaftaranKeluarSimpan') }}" method="POST"
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="input-group col-sm-12 col-md-7">
                                    ...
                                    <input type="text" class="form-control jumlah @error('jumlah') is-invalid @enderror"
