...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/img/logo-baru.png') }}">
    <!-- Template CSS -->
        ...
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar ">
                <ul class=" mr-3 navbarMarker">
                    <li><a href="#" data-toggle="sidebar" class="nav-link nav-link-lg navbarMarker"><i
                ...
                @if (auth()->user()->role == 'admin' || auth()->user()->role == 'projectmanager' || auth()->user()->role == 'marketing' || auth()->user()->role == 'adminGudang' || auth()->user()->role == 'kasir')
                    <form action="{{ route('cariPelangganHome') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row ">
                                            ...
                                            processResults: function(data) {
                                                return {
                                                    results: $.map(data, function(item) {
                                                        // console.log(data);
                                                        return {
                                                            text: item.nama + " " + item.kavling['blok'],
                            ...
                            <div class="input-group-prepend col-2">
                                <div class="input-group-text">
                                    <i class="fas fa-search"></i><input type="submit" class="submitCari"
                                        value="Cari">
                                </div>
                            </div>
                        </div>
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ url('/') }}">
                            <img src="{{ asset('assets/img/logo-baru.png') }}" alt="" width="200px"
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="@yield('menuDashboard')"><a class="nav-link" href="{{ route('home') }}"><i
                        ...
                        @if (auth()->user()->role == 'projectmanager' || auth()->user()->role == 'admin')
                            ...
                            <li class="nav-item dropdown @yield('menuPelanggan')">
                                ...
                                <ul class="dropdown-menu">
                                    <li class=" @yield('menupelangganIndex')"><a class="nav-link"
                                            href="{{ route('pelangganIndex') }}">Aktif</a></li>
                                    <li class=" @yield('menupelangganNonAktif')"><a class="nav-link"
                                            href="{{ route('pelangganNonAktif') }}">Tidak Aktif</a></li>
                                    <li class=" @yield('menupelangganTerhapus')"><a class="nav-link"
                            ...
                            <li class="nav-item dropdown @yield('menuTransaksi')">
                                ...
                                <ul class="dropdown-menu">
                                    <li class=" @yield('menuTransaksiMasuk')"><a
                                            href="{{ route('transaksiMasuk') }}">Masuk</a></li>
                                    <li class=" @yield('menuTransaksiKeluar')"><a
                            ...
                            <li class="nav-item dropdown @yield('menuKas')">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class=" @yield('menuKasKecil')"><a class="nav-link"
                                            href="{{ route('pettyCash') }}">Kas Kecil</a></li>
                                    <li class=" @yield('menuKasKecilLapangan')"><a class="nav-link"
                                            href="{{ route('kasKecilLapangan') }}">Kas Kecil Lapangan</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown @yield('menuGudang')">
                                <a href="" class="nav-link has-dropdown"> <i class="fas fa-warehouse    "></i>
                                    <span>Gudang</span></a>
                                <ul class="dropdown-menu">
                                    <li class=" @yield('menuGudangSisa')"><a href="{{ route('gudang') }}">Stok
                                            Sisa</a></li>
                                    <li class=" @yield('menuGudangHabis')"><a href="{{ route('gudangHabis') }}">Stok
                                            Habis</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown @yield('menuLaporan')">
                                ...
                                <ul class="dropdown-menu">
                                    <li class=" @yield('menuLaporanBulanan')"><a class="nav-link"
                                            href="{{ route('laporanBulanan') }}">Bulanan</a></li>
                                    <li class=" @yield('menuLaporanTahunan')"><a class="nav-link"
                                            href="{{ route('laporanTahunan') }}">Tahunan</a></li>
                                </ul>
                            </li>
                        @endif
                        ...
                        @if (auth()->user()->role == 'adminGudang')
                            ...
                            <li class="nav-item dropdown @yield('menuDataProyek')">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="@yield('menuKavling')"><a class="nav-link"
                                            href="{{ route('kavling') }}">Unit</a></li>
                                    <li class="@yield('menuRABGudang')"><a class="nav-link"
                                            href="{{ route('RABGudang') }}">RAB</a></li>
                                </ul>
                            </li>
                            <li class="menu-header">Menu Pelanggan</li>
                            <li class="nav-item dropdown @yield('menuPelanggan')">
                        ...
                        @if (auth()->user()->role == 'marketing')
                            ...
                            <li class="nav-item dropdown @yield('menuDataProyek')">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="@yield('menuKavling')"><a class="nav-link"
                                            href="{{ route('kavling') }}">Unit</a></li>
                                    <li class="@yield('menuPengembalianBatalAkad')"><a class="nav-link"
                                            href="{{ route('PengembalianBatalAkad') }}">Pengembalian Batal Akad</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="menu-header">Menu Pelanggan</li>
                        ...
                        @if (auth()->user()->role == 'pelanggan')
                            ...
                            <li class=" @yield('menuPembelianPelanggan')"><a class="nav-link"
                                    href="{{ route('pembelianPelanggan') }}"><i
                                        class="fas fa-handshake    "></i><span> Pembelian</span></a></li>
                            <li class=" @yield('menuDPPelanggan')"><a class="nav-link"
                                    href="{{ route('DPPelanggan') }}"><i class="fas fa-coins    "></i> <span>
                                        Cicilan
                                        DP</span></a></li>
                        ...
                        @if (auth()->user()->role == 'kasir')
                            ...
                            <li class=" @yield('menuCicilanUnit')"><a class="nav-link"
                                    href="{{ route('cicilanKavling') }}"><i class="fas fa-money-bill-wave"></i>
                                    <span> Cicilan Unit</span></a></li>
                            <li class=" @yield('menuTransaksiMasuk')"><a class="nav-link"
                                    href="{{ route('transaksiMasuk') }}"> <i class="fas fa-money-bill"></i> <span>
                                        Transaksi Masuk</span></a></li>
                            <li class="nav-item dropdown @yield('menuKas')">
                                <a href="" class="nav-link has-dropdown"><i class="fas fa-book"></i>
                                    <span>KAS</span></a>
                                <ul class="dropdown-menu">
                                    <li class=" @yield('menuKasBesar')"><a href="{{ route('cashFlow') }}">Input Kas
                                            Besar</a></li>
                                    <li class=" @yield('menuKasPendaftaran')"><a
                                            href="{{ route('kasPendaftaranMasuk') }}">Pendaftaran</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown @yield('menuEstimasi')">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2021 <div class="bullet"></div>Build And Design By <a
                        href="https://www.instagram.com/khadijah.itsolution/"><i class="fab fa-instagram"
                            aria-hidden="true"></i> Khadijah.itsolution</a>
                </div>
