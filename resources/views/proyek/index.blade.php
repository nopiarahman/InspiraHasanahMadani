                    ...
                    @foreach ($proyek as $pk)
                        <tr>
                            ...
                            <td><a href="{{ route('proyekEdit', ['id' => $pk->id]) }}"
                                    class="btn btn-white text-primary border-success"> <i class="fas fa-pen    "></i>
                                    Edit</a>
                                <button type="button" class="btn btn-sm btn-white text-danger border-danger"
                                    data-toggle="modal" data-target="#exampleModalCenter" data-id="{{ $pk->id }}"
                                    data-nama="{{ $pk->nama }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#exampleModalCenter').on('show.bs.modal', function(event) {
                ...
                var modal = $(this)
                modal.find('.modal-text').text('Yakin ingin menghapus proyek ' + nama + ' ?')
                document.getElementById('formHapus').action = '/hapusProyek/' + id;
            })
        });
    </script>
@endsection
