        ...
        <div class="card">
          ...
          <form action="{{route('biayaRABSimpan')}}" method="POST" enctype="multipart/form-data" onchange="hitung()">
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <input type="text" class="form-control @error('volume') is-invalid @enderror" name="volume" value="{{old('volume')}}" id="volume" placeholder="Hanya boleh berupa angka atau persen">
                @error('volume')
                  <div class="invalid-feedback">{{$message}}</div>
                @enderror
              </div>
