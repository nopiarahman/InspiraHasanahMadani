        ...
        <div class="card">
          ...
          <form action="{{route('rabUnitSimpan')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row mb-4 headerBaruUnit d-none" >
              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Input Header Baru</label>
              <div class="col-sm-12 col-md-7">
                <input type="text" class="form-control @error('headerBaru') is-invalid @enderror" name="header" value="{{old('headerBaru')}} " onchange="removeHeaderUnit()">
                @error('headerBaru')
                  <div class="invalid-feedback">{{$message}}</div>
                @enderror
              </div>
            ...
            <div class="form-group row mb-4 judulBaruUnit d-none" >
              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Input Judul Baru</label>
              <div class="col-sm-12 col-md-7">
                <input type="text" class="form-control @error('judulBaru') is-invalid @enderror" name="judul" value="{{old('judulBaru')}} " onchange="removeJudulUnit()">
                @error('judulBaru')
                  <div class="invalid-feedback">{{$message}}</div>
                @enderror
              </div>
            ...
            <div class="form-group row mb-4">
              ...
              <div class="input-group col-sm-12 col-md-7">
                ...
                <input type="text" class="hargaSatuanUnit form-control @error('hargaSatuan') is-invalid @enderror" name="hargaSatuan" value="{{old('hargaSatuan')}}" id="hargaSatuanUnit">
                @error('hargaSatuan')
                  <div class="invalid-feedback">{{$message}}</div>
                @enderror
              </div>
            ...
            <tr>
              ...
              <th>
                ...
                <button type="button" class="btn btn-sm btn-white text-primary border-success" 
                  ...
                  <button type="button" class="btn btn-sm btn-white text-danger border-danger" 
                  data-toggle="modal" 
                  data-target="#exampleModalCenterUnit" 
                  data-id="{{$rab->id}}" 
                  data-isi="{{$rab->isi}}">
                  <i class="fa fa-trash" aria-hidden="true" ></i> Hapus</button>
                  @endif
...
{{-- modal Edit --}}
<div class="modal fade modalEditUnit bd-example-modal-lg ml-5" id="modalEditUnit" tabindex="-1" role="dialog" aria-labelledby="modalEditTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Edit RAB</h5>
      ...
      <div class="modal-body">
        <form action="" method="POST" enctype="multipart/form-data" id="formEditUnit" onchange="hitung2()">
          ...
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Isi Biaya</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control @error('isi') is-invalid @enderror" name="isi" value="{{old('isi')}}" id="isiEditUnit">
              @error('isi')
                <div class="invalid-feedback">{{$message}}</div>
              @enderror
            </div>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="input-group col-sm-12 col-md-7">
              ...
              <input type="text" class="hargaSatuanEditUnit form-control @error('hargaSatuan') is-invalid @enderror" name="hargaSatuan" value="{{old('hargaSatuan')}}" id="hargaSatuanEditUnit">
              @error('hargaSatuan')
                <div class="invalid-feedback">{{$message}}</div>
              @enderror
            </div>
...
<!-- Modal Hapus-->
<div class="modal fade exampleModalCenterUnit" id="exampleModalCenterUnit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Hapus RAB</h5>
