    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
                <div class="col">
                    @if ($id->getTable() == 'rab')
                        <form action="{{ route('transaksiRAB', ['id' => $id->id]) }}" method="get"
                            enctype="multipart/form-data">
                        @elseif($id->getTable() == 'rabunit')
                            <form action="{{ route('transaksiRABUnit', ['id' => $id->id]) }}" method="get"
                                enctype="multipart/form-data">
                    @endif
                    <select class="form-control col-md-8" name="bulan" id="" onchange="this.form.submit()">
                        <option value="" @if ($bulanTerpilih === 0) selected @endif>Semua Pengeluaran</option>
                        @forelse ($periode as $p)
                            <option value="{{ $p }}" @if ($bulanTerpilih === $p) selected @endif>
                                {{ filterBulan($p) }}</option>
                        @empty
                        @endforelse
                    </select>
                    </form>
                ...
                <div class="col-md-8 col-sm-12">
                    ...
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-sm-12 col-md-6 col-lg-6 mt-1 mr-n3"> <span
            ...
            <table class="table table-sm table-striped" id="table">
                                ...
                                <td>
                                    ...
                                    @if (auth()->user()->role == 'admin' || auth()->user()->role == 'projectmanager')
                                        ...
                                        @if (request()->route()->getName() == 'transaksiRABUnit' ||
                                            ...
                                            <button type="button"
                                                class="btn btn-sm btn-white text-    border-primary"
                ...
                <tfoot>
                    <tr>
                        <td colspan="4" style="text-align: right; font-weight:bold;" class="text-primary">
                            <h5> Total: {{ number_format($totalFilter) }}</h5>
                        </td>
                    </tr>
                </tfoot>
            </table>
