...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('proyekUpdate', ['id' => $proyek->id]) }}" method="POST"
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control @error('alamatPT') is-invalid @enderror"
                                    name="alamatPT" value="{{ $proyek->alamatPT }}">
                                @error('alamatPT')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="email" class="form-control @error('emailPT') is-invalid @enderror"
                                    name="emailPT" value="{{ $proyek->emailPT }}">
                                @error('emailPT')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="date" class="form-control @error('proyekStart') is-invalid @enderror"
                                    name="proyekStart" value="{{ $proyek->proyekStart }}">
                                @error('proyekStart')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                <div class="feedback"><span>
                                        <strong> Perhatian!!, Mengedit Prefix akan menganti username pelanggan yang telah
                                            ada!</strong></span></div>
                                @error('prefix')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
