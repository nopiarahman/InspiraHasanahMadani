    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="form-group row mb-4">
          ...
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control @error('namaPT') is-invalid @enderror" name="namaPT" value="{{old('namaPT')}}">
            @error('namaPT')
        ...
        <div class="form-group row mb-4">
          ...
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control @error('alamatPT') is-invalid @enderror" name="alamatPT" value="{{old('alamatPT')}}">
            @error('alamatPT')
              <div class="invalid-feedback">{{$message}}</div>
            @enderror
          </div>
        ...
        <div class="form-group row mb-4">
          ...
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control @error('telpPT') is-invalid @enderror" name="telpPT" value="{{old('telpPT')}}">
            @error('telpPT')
              <div class="invalid-feedback">{{$message}}</div>
            @enderror
          </div>
        ...
        <div class="form-group row mb-4">
          ...
          <div class="col-sm-12 col-md-7">
            <input type="email" class="form-control @error('emailPT') is-invalid @enderror" name="emailPT" value="{{old('emailPT')}}">
            @error('emailPT')
              <div class="invalid-feedback">{{$message}}</div>
            @enderror
          </div>
      ...
      <div class="card-body">
        ...
        <div class="form-group row mb-4">
          ...
          <div class="col-sm-12 col-md-7">
            <input type="date" class="form-control @error('proyekStart') is-invalid @enderror" name="proyekStart" value="{{old('proyekStart')}}">
            @error('proyekStart')
              <div class="invalid-feedback">{{$message}}</div>
            @enderror
          </div>
