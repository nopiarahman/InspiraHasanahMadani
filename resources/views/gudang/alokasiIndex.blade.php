    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('alokasiSimpan') }}" method="POST" enctype="multipart/form-data"
                        onchange="hitung2()">
                        @csrf
              ...
              <input type="text" readonly class="form-control" name="" id="isiNamaAkun" value="{{old('isiNamaAkun')}}">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                <input type="text" hidden class="form-control" name="gudang_id"
                                    value="{{ $id->id }}">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control jumlah @error('uraian') is-invalid @enderror"
                                    name="jumlah" value="{{ old('jumlah') }}" id="jumlahBarang"
                                    max="{{ $id->sisa }}">
                                @error('jumlah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="input-group col-sm-12 col-md-7">
                                ...
                                <input type="text" readonly
                                    ...
                                    name="hargaSatuan" value="{{ $id->harga }}" id="hargaSatuan">
                                @error('hargaSatuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
