...
@section('menuestimasiRumah', 'active')
@section('content')
    <div class="section-header sticky-top">
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <h1>Estimasi Rumah </h1>
                </div>
                <div class="kanan">
                    <div class="kanan">
                        <form action="{{ route('estimasiRumah') }}" method="get" enctype="multipart/form-data">
        ...
        <div class="col-md-6 col-sm-12">
            <div class="card card-hero ">
                <div class="card-header" style="background-image: linear-gradient(to bottom, #ffd208, #ee9c03);">
                    ...
                    <h4>Rp. {{ number_format($totalCicilan + $totalDP) }}</h4>
        ...
        <div class="col-md-6 col-sm-12">
            <div class="card card-hero ">
                <div class="card-header" style="background-image: linear-gradient(to bottom, #8fe700, #03a827);">
                    ...
                    <h4>Rp. {{ number_format($totalTerbayar + $totalDPTerbayar) }}</h4>
