              ...
              <input type="text" readonly class="form-control" name="" id="isiNamaAkun" value="{{old('isiNamaAkun')}}">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="input-group col-sm-12 col-md-7">
                                    <a href="#" class="btn btn-primary" data-toggle="modal"
                                        data-target="#pilihRAB">Pilih RAB</a>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text"
                                        ...
                                        value="{{ old('jumlah') }}" id="jumlahBarang">
                                    @error('jumlah')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="input-group col-sm-12 col-md-7">
                                    ...
                                    <input type="text" readonly
                                        class="form-control hargaSatuan @error('hargaSatuan') is-invalid @enderror"
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="input-group col-sm-12 col-md-7">
                                    ...
                                    <input type="text"
                                        class="form-control totalHarga @error('total') is-invalid @enderror"
                                        name="total" value="{{ old('total') }}" id="totalHarga">
                                    @error('total')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="sumberKas" value="kasBesar"
                                            class="selectgroup-input" checked="">
                                        <span class="selectgroup-button">Kas Besar</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="sumberKas" value="pettyCash"
                        ...
                        <td>
                            ...
                            @if (auth()->user()->role == 'admin' || auth()->user()->role == 'projectmanager' || auth()->user()->role == 'marketing')
                                <button type="button" class="btn btn-sm btn-white text-danger border-danger"
                                    data-toggle="modal" data-target="#hapusTransaksi" data-id="{{ $transaksi->id }}"
                                    data-uraian="{{ $transaksi->uraian }}">
