...
<table cellspacing="0" border="0">
	<tbody>
		...
		<tr>
			<td colspan="4" align="center" style="padding:10px; border-top:1px solid;"><b><font size="5" color="#00B050">KWITANSI DP</b></td>
		</tr>
		<tr>
	...
	<tr>
		<td>Total Hutang</td>
		<td>: Rp {{number_format($pembelian->dp)}}</td>
		<td rowspan="5" colspan="2" align="center"> <img src="{{public_path(Storage::url($proyek->logoPT))}}" width="100px"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>Sisa Hutang</td>
		<td>: Rp. {{number_format($pembelian->dp-$sampaiSekarang->sum('jumlah'))}}</td>
		</tr>
	<tr>
		<td>Status</td>
