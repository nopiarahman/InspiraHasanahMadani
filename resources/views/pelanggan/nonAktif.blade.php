    ...
    <div class="section-header">
        <div class="container">
            <div class="row">
                ...
                <div class="kanan">
                    <a href="{{ route('pelangganNonAktifExport') }}" class="btn btn-primary"> <i
                ...
                <tbody>
                    @foreach ($pelangganNonAktif as $pelanggan)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('pelangganDetail', ['id' => $pelanggan->id]) }}"
                                    class="btn btn-white text-primary border-success btn-sm">Detail</a>
                                @if (auth()->user()->role == 'admin')
                                    <button type="button" class="btn btn-sm btn-white text-danger border-danger"
                                        data-toggle="modal" data-target="#exampleModalCenter" data-id="{{ $pelanggan->id }}"
                            ...
                            @if (auth()->user()->role == 'admin' ||
                                ...
                                auth()->user()->role == 'marketing')
                                <td>
                                    <a href="{{ route('pengembalian', ['id' => $pelanggan->id]) }}"
                                        class="btn btn-white text-primary border-success btn-sm"> <i class="fa fa-check"
                                            aria-hidden="true"></i> Input</a>
                                </td>
                            @endif
                        </tr>
                    @endforeach
