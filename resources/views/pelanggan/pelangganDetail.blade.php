        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card profile-widget">
                <div class="profile-widget-header">
                    <img alt="image"
                        @if (detailUser($id->user_id) != null) @if (detailUser($id->user_id)->poto != null)
            src="{{ Storage::url(detailUser($id->user_id)->poto) }}"
            @else
            src="{{ asset('assets/img/avatar/avatar-1.png') }}" @endif
                    @else src="{{ asset('assets/img/avatar/avatar-1.png') }}" @endif
                    class="rounded-circle profile-widget-picture">
                    <div class="profile-widget-items">
                        <div class="profile-widget-item">
                            <div class="profile-widget-item-label">Blok</div>
                            <div class="profile-widget-item-value">
                                @if ($dataKavling == null)Akad Dibatalkan
                                    @else{{ $dataKavling->blok }}@endif
                            </div>
                        </div>
                        <div class="profile-widget-item">
                        ...
                        <div class="profile-widget-item">
                            @if ($dataKavling == null)
                                <button onclick="document.title='{{ $id->nama . ' batal akad' }}';cetak('cetakPelanggan')"
                                    class="btn btn-primary m-2"> <i class="fas fa-print fa-L"></i> Cetak Pelanggan</button>
                            @else
                                <button
                                    onclick="document.title='{{ $id->nama . ' blok ' . $id->kavling->blok }}';cetak('cetakPelanggan')"
                                    class="btn btn-primary m-2"> <i class="fas fa-print fa-L"></i> Cetak Pelanggan</button>
                            @endif
                        </div>
                    </div>
                ...
                <div class="profile-widget-description">
                    ...
                    <table class="table table-hover table-responsive-sm">
                        <tbody>
                            <tr>
                                <th>Objek</th>
                                <td style="width: 30%">{{ jenisKepemilikan($id->id) }} ( @if ($dataKavling == null)Akad Dibatalkan
                                        @else{{ $dataKavling->blok }}@endif )</td>
                                <td></td>
                            </tr>
                            <tr>
                                <th>Status</th>
                                @if ($dataKavling != null)
                                    @if ($dataPembelian->statusPembelian == 'Booking')
                                        <td><span class="text-info">{{ cekStatusKavling($dataKavling->id) }} /
                                                {{ carbon\carbon::parse($dataKavling->pembelian->tanggalBooking)->isoFormat('D MMMM Y') }}</span>
                                        </td>
                                    @else
                                        <td><span class="text-info">{{ cekStatusKavling($dataKavling->id) }}</span>
                                        </td>
                                    @endif
                                    <td>
                                        @if ($dataPembelian->statusPembelian == 'Booking')
                            ...
                            <tr>
                                ...
                                <td>Rp.{{ number_format($dataPembelian->dp - cekTotalDp($dataPembelian->id)) }}
                                    @if ($dataPembelian->dp <= cekTotalDp($dataPembelian->id))
                                        /
                                        <span class="badge badge-info text-white"><i class="fas fa-check"></i>
                                            Lunas</span>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('DPKavlingTambah', ['id' => $dataPembelian->id]) }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('unitKavlingDetail', ['id' => $dataPembelian->id]) }}"
                                        class="btn btn-white text-primary border-success">Lihat Pembayaran</a>
                                </td>
                            </tr>
                        </tbody>
        ...
        @if (auth()->user()->role == 'admin' || auth()->user()->role == 'projectmanager' || auth()->user()->role == 'kasir')
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <form action="{{ route('pelangganUpdate', ['id' => $id->id]) }}" method="POST"
                        ...
                        <form class="card-body" id="pertama">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        name="email" value="{{ $dataPembelian->pelanggan->email }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tempat & Tanggal
                                    Lahir</label>
                                <div class="col-sm-6 col-md-3">
                                    <input type="text" class="form-control @error('tempatLahir') is-invalid @enderror"
                                        name="tempatLahir" value="{{ $dataPembelian->pelanggan->tempatLahir }}">
                                    @error('tempatLahir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <input type="date" class="form-control @error('tanggalLahir') is-invalid @enderror"
                                        name="tanggalLahir" value="{{ $dataPembelian->pelanggan->tanggalLahir }}">
                                    @error('tanggalLahir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                        name="alamat" value="{{ $dataPembelian->pelanggan->alamat }}">
                                    @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror"
                                        name="pekerjaan" value="{{ $dataPembelian->pelanggan->pekerjaan }}">
                                    @error('pekerjaan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text"
                                        class=" input-phone form-control @error('nomorTelepon') is-invalid @enderror"
                                        name="nomorTelepon" value="{{ $dataPembelian->pelanggan->nomorTelepon }}">
                                    @error('nomorTelepon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text"
                                        class=" input-phone form-control @error('noDarurat') is-invalid @enderror"
                                        name="noDarurat" value="{{ $dataPembelian->pelanggan->noDarurat }}">
                                    @error('noDarurat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        @if ($id->kavling != null)
                            <div class="card-header ">
                                ...
                                <button type="button" class="btn btn-sm btn-danger text-white ml-3" data-toggle="modal"
                                    data-target="#exampleModalCenter" data-id="{{ $id->id }}"
                                    data-nama="{{ $id->nama }}">
        ...
        $(document).ready(function() {
            $('#exampleModalCenter').on('show.bs.modal', function(event) {
                ...
                modal.find('.modal-text').text(
                    'Perhatian!, Pelanggan yang telah dibatalkan akad tidak bisa dikembalikan kembali ke Aktif!, Yakin ingin Membatalkan akad ' +
                    nama + ' ?, ')
        ...
        <form action="{{ route('unitPelangganUpdate', ['id' => $id->id]) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    ...
                    <select class="cari form-control @error('kavling_id') is-invalid @enderror"
                        style="width:300px;height:calc(1.5em + .75rem + 2px);" name="kavling_id">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <label class="selectgroup-item">
                        <input type="radio" name="includePembelian" value="" class="selectgroup-input"
                            @if ($dataPembelian->rumah_id == null && $dataPembelian->kios_id == null) checked @endif id="notInclude">
            ...
            <div id="luasBangunan"
                @if ($dataPembelian->rumah_id != null || $dataPembelian->kios_id != null) style="display:block" @else  style="display: none" @endif>
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Luas Bangunan</label>
                    <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control @error('luasBangunan') is-invalid @enderror"
                            name="luasBangunan" value="{{ luasBangunanPelanggan($dataPembelian->pelanggan_id) }}"
                            placeholder="kosongkan jika data belum ada">
                        @error('luasBangunan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <input type="text" class="form-control @error('nomorAkad') is-invalid @enderror" name="nomorAkad"
                        value="{{ $dataPembelian->nomorAkad }}">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="input-group col-sm-12 col-md-7">
                    ...
                    <input type="text" class="form-control harga" id="harga" name="harga"
                        value="{{ $dataPembelian->harga }}">
                </div>
            </div>
            <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Diskon</label>
                <div class="input-group col-sm-12 col-md-7">
                    <input type="text" class="persenDiskon form-control @error('diskon') is-invalid @enderror"
                        name="diskon" value="{{ $persenDiskon }}" min="0" max="100" id="diskon">
                    @error('diskon')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div class="input-group-prepend">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="input-group col-sm-12 col-md-7">
                    ...
                    <input type="text" readonly class="sisaKewajiban form-control" name="sisaKewajiban"
                        value="{{ $dataPembelian->sisaKewajiban }}" id="sisaKewajiban">

                    <div class="input-group-prepend">
                        <div class="input-group-text " style="border: none">
                            <label class="selectgroup-item ">
                                <input type="radio" name="statusCicilan" value="Credit" class="selectgroup-input"
                                    checked="" id="statusCicilanCredit">
                                <span class="selectgroup-button">Credit</span>
                            </label>
                            <label class="selectgroup-item ">
                                <input type="radio" name="statusCicilan" value="Cash" class="selectgroup-input"
                                    id="statusCicilanCash">
                                <span class="selectgroup-button">Cash</span>
                            </label>
                            @error('statusCicilan')
                                <div class="invalid-feedback">{{ $message }}</div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="nomorAkad" data-backdrop="false">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('simpanNomorAkad', ['id' => $dataPembelian->id]) }}"
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="tanggalAkad" data-backdrop="false">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('simpanTanggalAkad', ['id' => $dataPembelian->id]) }}"
                        class="" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-1">
                            <div class="col-sm-4">
