<table class="table table-sm table-hover table-striped mt-3">
  ...
  <tbody>
      <tr>
        ...
        <th style="width: 20pt; font-weight:bold;" class="text-primary">{{saldoPettyCashBulanSebelumnya($start)}}</th>
      </tr>
  ...
  <tfoot>
    <tr class="bg-light">
      ...
      <th style="width: 20pt; font-weight:bold;" class="text-primary">{{$pettyCash->sum('kredit')}}</th>
      <th style="width: 20pt; font-weight:bold;" class="text-primary">{{$pettyCash->sum('debet')}}</th>
      <th style="width: 20pt; font-weight:bold;" colspan="2" class="text-primary">{{totalPettyCash($start,$end)}}</th>
