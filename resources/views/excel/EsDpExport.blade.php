<table class="table table-sm table-striped table-hover mt-3">
    <thead>
        <tr>
            <th style="font-weight: bold; weight:20px; font-size:22pt; text-align:center" colspan="7">Estimasi Kavling
            </th>
        </tr>
        <tr>
    ...
    <tfoot>
        <tr class="bg-light">
            <th style="font-weight: bold; weight:20px" colspan="3" class="text-right text-primary">Total Estimasi
                Pendapatan : </th>
            <th style="font-weight: bold; weight:20px" class="text-primary">{{ $totalDP + $totalCicilan }}</th>
            <th style="font-weight: bold; weight:20px" class="text-primary">{{ $totalDPTerbayar + $totalTerbayar }}
            </th>
        </tr>
    </tfoot>
</table>
