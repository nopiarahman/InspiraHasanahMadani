<table class="table table-sm table-striped table-hover mt-3">
    <thead>
        <tr>
            <th style="font-weight: bold; weight:20px; font-size:22pt; text-align:center" colspan="7">Pengembalian Dana
                Batal Akad</th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{ cekTotalDp($id->pembelian->id) }}</td>
        </tr>
        <tr>
            <th>Total Pembayaran Unit</th>
            <td>{{ cicilanTerbayarTotal($id->pembelian->id) }}</td>
        </tr>
        <tr>
            <th>Potongan Biaya</th>
            <td>{{ $id->pembelian->pengembalian }}
            </td>
        </tr>
        <tr>
            <th>Total Pengembalian Dana</th>
            <td>{{ cekTotalDp($id->pembelian->id) + cicilanTerbayarTotal($id->pembelian->id) - $id->pembelian->pengembalian }}
            </td>
        </tr>
        <td></td>
        <tr>
