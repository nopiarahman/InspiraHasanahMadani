<table>
    ...
    <tr>
        <th style="width: 20pt;text-align:center;font-style:italic" colspan="3">Periode :
            {{ Carbon\Carbon::parse($start)->isoFormat('DD MMMM Y') }} -
    ...
    <tbody>
        ...
        <tr>
            <th style="width: 20pt;font-weight:bold;" scope="col" colspan="3">Penerimaan</th>
        </tr>
        ...
        @endforeach
        <tr>
            <th colspan="2">Penerimaan Bulan {{ \Carbon\carbon::parse($start)->isoFormat('MMMM') }}</th>
            @if ($pendapatan != null)
    ...
    <tfoot>
        ...
        <tr>
            ...
            <th style="width: 20pt;font-weight:bold;">
                {{ saldoBulanSebelumnya($start) + $pendapatan->sum('kredit') - (array_sum($b) + array_sum($bRAB)) }}</th>
        </tr>
    </tfoot>
</table>
