...
@section('content')
                        ...
                        <form action="{{ route('DPKavlingSimpan') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="input-group col-sm-12 col-md-7">
                                    ...
                                    <input type="text" readonly class="akadDp form-control" value="{{ $id->dp }} "
                                        id="totalDiskon">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                ...
                                <div class="input-group col-sm-12 col-md-7">
                                    ...
                                    <input type="text" readonly class="akadDp form-control"
                                        value="{{ number_format($id->dp - $sampaiSekarang->sum('jumlah')) }} "
                                        id="totalDiskon">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="metode" value="cash" class="selectgroup-input" checked
                                            id="metodeCashDp" onclick="cash()">
                                        <span class="selectgroup-button">Cash</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="metode" value="transfer" id="" class="selectgroup-input"
                                            id="metodeTransferDp" onclick="transfer()">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <button class="btn btn-primary" type="submit"
                                        @if ($id->sisaDp == 0) disabled @endif>Tambah Pembayaran</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <tbody>
                    @foreach ($daftarCicilanDp as $cicilanDp)
                        <tr>
                            ...
                            <td>Rp.{{ number_format($cicilanDp->pembelian->dp - dpTerbayar($cicilanDp->pembelian->id, $cicilanDp->tanggal)) }}
                            </td>
                            <td>
                            ...
                            <td>
                                @if (auth()->user()->role == 'admin' || auth()->user()->role == 'projectmanager' || auth()->user()->role == 'marketing' || auth()->user()->role == 'kasir')
                                    <a href="{{ route('cetakKwitansiDp', ['id' => $cicilanDp->id]) }}"
                                ...
                                @if (auth()->user()->role == 'admin' || auth()->user()->role == 'projectmanager' || auth()->user()->role == 'kasir')
                                    ...
                                    <button type="button" class="btn btn-sm btn-white text-info border-info"
                                        ...
                                        {{-- data-tp="{{formatTanggal($cicilanDp->tanggal)}}" --}} data-jumlah="{{ $cicilanDp->jumlah }}"
                                        ...
                                        @if (($id->dp / $id->tenorDP) * bulanDpBerjalan($cicilanDp) - dpTerbayar($cicilanDp->pembelian->id, $cicilanDp->tanggal) > $cicilanDp->pembelian->dp - dpTerbayar($cicilanDp->pembelian->id, $cicilanDp->tanggal)) data-kurang="{{ $cicilanDp->pembelian->dp - dpTerbayar($cicilanDp->pembelian->id, $cicilanDp->tanggal) }}"
            @else
            data-kurang="{{ ($id->dp / $id->tenorDP) * bulanDpBerjalan($cicilanDp) -dpTerbayar($cicilanDp->pembelian->id, $cicilanDp->tanggal) }}" @endif>
    ...
    {{-- Modal Detail --}}
    <div class="modal fade modalDetail bd-example-modal-lg ml-5" id="modalDetail" tabindex="-1" role="dialog"
