...
@section('content')
        ...
        <div class="col-12">
            @if (session('statusGudang'))
                <div class="alert alert-success alert-dismissible show fade">
                    ...
                    {{ session('statusGudang') }} <a href="{{ route('gudang') }} "
                        class="badge badge-warning text-dark">Lihat Gudang</a>
                </div>
            @endif
        </div>
    </div>
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" readonly class="form-control" name="" id="isiNamaAkun" value="{{old('isiNamaAkun')}}">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="input-group col-sm-12 col-md-7">
                                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#pilihRAB">Pilih
                                    RAB</a>
                                ...
                                <a href="#" class="btn btn-primary" data-toggle="modal"
                                    data-target="#pilihRABUnit">Pilih Biaya Unit</a>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                <input type="text" readonly class="form-control" name="" id="isiRAB"
                                    value="{{ old('isi') }}">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control @error('uraian') is-invalid @enderror"
                                    name="uraian" value="{{ $id->namaBarang }} {{ $id->merek }}">
                                @error('uraian')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" readonly
                                    class="form-control jumlah @error('uraian') is-invalid @enderror" name="jumlah"
                                    value="{{ $id->jumlahBarang }}" id="jumlahBarang">
                                @error('jumlah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" readonly class="form-control @error('uraian') is-invalid @enderror"
                                    name="satuan" value="{{ $id->satuan }}">
                                @error('satuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Harga Estimasi</label>
                            <div class="input-group col-sm-12 col-md-7">
                                ...
                                <input type="text" readonly
                                    class="form-control hargaSatuan @error('hargaEstimasi') is-invalid @enderror"
                                    name="hargaEstimasi" value="{{ $id->harga }}" id="hargaEstimasi">
                                @error('hargaEstimasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Harga Real</label>
                            <div class="input-group col-sm-12 col-md-7">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        Rp
                                ...
                                <input type="text"
                                    class="form-control hargaReal @error('hargaSatuan') is-invalid @enderror"
                                    name="hargaSatuan" value="" id="hargaSatuan">
                                @error('hargaSatuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="input-group col-sm-12 col-md-7">
                                ...
                                <input type="text" readonly
                                    class="form-control totalHarga @error('total') is-invalid @enderror" name="total"
                                    value="" id="totalHarga">
                                @error('total')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <label class="selectgroup-item">
                                    <input type="radio" name="sumberKas" value="kasBesar" class="selectgroup-input"
                                        checked="">
                                ...
                                <label class="selectgroup-item">
                                    <input type="radio" name="sumberKas" value="kasKecilLapangan"
                            ...
                            <td>
                                @if ($transaksi->sumber != 'Gudang')
                                    @if (cekGudang($transaksi->id) == true)
                                        <a href="{{ route('gudang') }}" type="button"
                                    ...
                                    @else
                                        <button type="button" class="btn btn-sm btn-white text-primary border-success"
                                            data-toggle="modal" data-target="#keGudang" data-id="{{ $transaksi->id }}"
                                            ...
                                            data-total="{{ $transaksi->debet }}" {{-- data-akun="{{$transaksi->akun->id}}" 
              data-awal="{{$transaksi->akun->namaAkun}}" --}}>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th colspan="2" class="text-primary">Rp. {{ number_format($transaksiKeluar->sum('debet')) }}
                        </th>
                    </tr>
                </tfoot>
            </table>
    ...
    {{-- modal keGudang --}}
    <div class="modal fade keGudang bd-example-modal-lg ml-5" id="keGudang" tabindex="-1" role="dialog"
        aria-labelledby="keGudangTitle" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data" id="formTransfer"
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control @error('alokasiAwal') is-invalid @enderror"
                                    name="alokasiAwal" value="" id="alokasiAwal">
                                @error('alokasiAwal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Satuan</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" readonly class="form-control @error('satuan') is-invalid @enderror"
                                    name="satuan" value="" id="satuan">
                                @error('satuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="input-group col-sm-12 col-md-7">
                                ...
                                <input type="text" readonly
                                    class="hargaGudang form-control @error('harga') is-invalid @enderror" name="harga"
                                    value="" min="0" max="100" id="harga">
                                @error('harga')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="input-group col-sm-12 col-md-7">
                                ...
                                <input type="text" readonly
                                    class="totalGudang form-control @error('total') is-invalid @enderror" name="total"
                                    value="{{ old('total') }} " min="0" max="100" id="total">
                                @error('total')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="number" class="form-control @error('terpakai') is-invalid @enderror"
    ...
    {{-- modal RAB --}}
    <div class="modal fade" id="pilihRAB" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <table class="table table-sm table-hover">
                            ...
                            <tbody>
                                @foreach ($perHeader as $header => $semuaRAB)
                                    <tr>
                                        <th colspan="6" class="bg-primary text-light">{{ $loop->iteration }}.
                                            {{ $header }}</th>
                                    </tr>
                                    @foreach ($perJudul[$header] as $judul => $semuaRAB)
                                        <tr>
                                            <th colspan="6" class="bg-light">{{ $loop->iteration }}.
                                                {{ $judul }}</th>
                                        </tr>
                                        @foreach ($semuaRAB as $rab)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="badge badge-info pilihRAB"
                                                        data-id-rab={{ $rab->id }} data-isi="{{ $rab->isi }}"
                                                        id="rab">Pilih</a>
                                                </td>
                                            </tr>
                                        @endforeach
    ...
    {{-- modal biaya Unit --}}
    <div class="modal fade " id="pilihRABUnit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                                    ...
                                    @foreach ($perJudulUnit[$header] as $judul => $semuaRABUnit)
                                        ...
                                        @foreach ($semuaRABUnit as $rab)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="badge badge-info pilihRAB"
                                                        data-id-unit={{ $rab->id }} data-isi="{{ $rab->isi }}"
                                                        id="rabUnit">Pilih</a>
                                                </td>
                                            </tr>
                                        @endforeach
    ...
    <script>
        ...
        var cleave = new Cleave('.hargaReal', {
            numeral: true,
            numeralThousandsGroupStyle: 'thousand'
        });
