    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
          <form action="{{route('isiPengadaanSimpan',['id'=>$id->id])}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group row mb-4">
              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Barang</label>
              <div class="col-sm-12 col-md-7">
                <select class="cari form-control" style="width:300px;height:calc(1.5em + .75rem + 2px);" name="barang_id"></select>
                  ...
                  $('.cari').select2({
                                      ...
                                      processResults: function (data) {
                                          ...
                                          results:  $.map(data, function (item) {
                                              return {
                                              text: item.namaBarang+" "+item.merek+" Rp."+item.harga+"/"+item.satuan, /* memasukkan text di option => <option>namaSurah</option> */
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <input type="text" class="form-control @error('jumlahBarang') is-invalid @enderror" name="jumlahBarang" value="{{old('jumlahBarang')}}">
                @error('jumlahBarang')
                  <div class="invalid-feedback">{{$message}}</div>
                @enderror
              </div>
        ...
        <table class="table table-responsive-sm table-hover" id="table">
              ...
              <tr>
                ...
                <td>
                  ...
                  @if(auth()->user()->role=="admin" || auth()->user()->role=="adminGudang" || auth()->user()->role=="marketing")
                    ...
                    <a href="#" class="btn btn-sm text-info border-info"> <i class="fas fa-check" aria-hidden="true"></i> Transaksi dibuat</a>
                    @endif
                  @endif
                </td>
              </tr>
          ...
          <tfoot>
            <tr>
              ...
              <th colspan="4" class="bg-secondary  text-primary">Rp. {{number_format($semuaIsi->sum('totalHarga'))}}</th>
            </tr>
          </tfoot>
        </table>
      </div>
