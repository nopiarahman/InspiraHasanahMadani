...
@section('content')
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif(auth()->user()->role == 'projectmanager')
                                    <a href="{{ route('isiPengadaan', ['id' => $pengadaan->id]) }}"
                                        class="btn btn-white border-success text-primary"> <i class="fas fa-pen    "></i>
                                        Periksa </a>
                                @endif
                            </td>
                        </tr>
    ...
    <div class="modal fade tambahPengadaan bd-example-modal-lg ml-5" id="tambahPengadaan" tabindex="-1" role="dialog"
        aria-labelledby="tambahPengadaanTitle" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="{{ route('pengadaanSimpan') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control @error('yangMengajukan') is-invalid @enderror"
                                    name="yangMengajukan" value="">
                ...
                <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data" id="formEdit">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control @error('kodeAkun') is-invalid @enderror"
                                    name="kodeAkun" value="" id="kodeEdit">
                                @error('kodeAkun')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control @error('namaAkun') is-invalid @enderror"
                                    name="namaAkun" value="" id="namaEdit">
                                @error('namaAkun')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
