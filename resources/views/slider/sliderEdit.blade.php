    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
          <form action="{{route('sliderUpdate',['id'=>$id->id])}}" method="POST" enctype="multipart/form-data">
            @method('patch')
            @csrf
            <div class="form-group row mb-4">
              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Judul </label>
              <div class="col-sm-12 col-md-7">
                <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" id="judul" value="{{$id->judul}}">
                @error('judul')
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <img src="{{Storage::url($id->gambar)}}" alt="" width="200px">
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <textarea name="text" id="editor">{!!$id->text!!}</textarea>
              </div>
            </div>
            <div class="form-group row mb-4">
              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">link</label>
              <div class="col-sm-12 col-md-7">
                <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" id="link" value="{{$id->link}}">
                @error('link')
                  <div class="invalid-feedback">{{$message}}</div>
                @enderror
              </div>
