							...
							<div class="blog_list_wrap">
								<ul>
									...
									<li>
										<div class="inner">
											<div class="date_wrap">
												<h3><span>{{Carbon\Carbon::parse($b->tanggal)->isoformat('DD')}}</span></h3>
												<h5>{{Carbon\Carbon::parse($b->tanggal)->isoformat('MMM')}}</h5>
												<h5>{{Carbon\Carbon::parse($b->tanggal)->isoformat('YYYY')}}</h5>
											</div>
											<div class="image cover">
												<a href="{{route('kabar_berita',['id'=>$b->id])}}"><img src="{{Storage::url($b->thumbnail)}}" alt=""/></a>
											</div>
											<div class="definitions_wrap">
												<div class="title_holder">
													<h3><a href="{{route('kabar_berita',['id'=>$b->id])}}">{{$b->judul}}</a></h3>
												</div>
												<div class="info_wrap">
													<div class="short_info">
														<span class="date">{{Carbon\Carbon::parse($b->tanggal)->isoformat('DD MMMM YYYY')}}</span>
														<span class="by">Oleh {{$b->author}}</span>
														<span class="category">in <a href="#">{{$b->proyek->nama}}</a></span>
													</div>
												</div>
												<div class="text">
												...
												<div class="continue">
													<a href="{{route('kabar_berita',['id'=>$b->id])}}">Read More</a>
												</div>
											</div>
										</div>
									</li>
