            ...
            <div class="glax_tm_header_wrap" data-style="light" data-position="relative">
                <div class="container">
                    <div class="header_inner_wrap">
                        ...
                        <div class="logo_wrap">
                            <img src="{{ asset('frontPage/img/logo-baru.png') }}" alt="" />
                    ...
                    <div class="container">
                        <div class="inner_wrap">
                            <div class="logo_wrap " style="align-content: center">
                                <a href="/"><img src="{{ asset('frontPage/img/logo-baru.png') }}"
                                        alt="" /></a>
                            </div>
                    ...
                    <div class="glax_tm_justified_content">
                        <div class="leftpart">
                            ...
                            <div class="glax_tm_project_video">
                                ...
                                <a class="project_video_button popup-youtube"
                                    href="https://www.youtube.com/watch?v=se4yc09w7Ic"></a>
                            </div>
                        </div>
                        <div class="rightpart">
                            <div class="infobox">
                                <ul>
                                    <li>
                                        <img src="{{ Storage::url($id->logo) }}" alt=""
