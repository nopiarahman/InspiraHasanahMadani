            ...
            <div class="glax_tm_section">
                <div class="glax_tm_about_wrap">
                    <div class="container">
                        <div class="subtitle">
                            <p>
                                PT. Inspira Hasanah Madani menjadi penyelenggara pembangunan perumahan dengan konsep
                                syariah dan pengembangan di bidang konstruksi Oleh sebab itu, kami senantiasa melihat
                                jauh kedepan, dimana hal ini memerlukan niat dan tekad yang kuat dalam hal pelaksanaan
                                di lapangan.
                        ...
                        <div class="about_service_list">
                            ...
                            <p>
                                Berdasarkan Akte Pendirian Pt. Inspira Hasanah Madani Adalah Untuk Melaksanakan Jenis
                                Usaha Di Bidang Pembangunan (Real Estate dan Developer Gedung), Konstruksi.
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="inner_counter">
                                <div class="leftbox">
                                    <div class="glax_tm_counter_wrap" data-col="4" data-delay="300">
                                        <ul class="glax_tm_counter_list">
                                            <li>
                                                <div class="inner">
                                                    <h3><span><span class="glax_tm_counter" data-from="0" data-to="530"
                                            ...
                                            <li>
                                                <div class="inner">
                                                    <h3><span><span class="glax_tm_counter" data-from="0" data-to="300"
                                                                data-speed="3000">0</span>+</span></h3>
                                            ...
                                            <li>
                                                <div class="inner">
                                                    <h3><span><span class="glax_tm_counter" data-from="0" data-to="120"
                                                                data-speed="3000">+</span></span></h3>
                                ...
                                <div class="rightbox">
                                    <div class="inner_rightbox">
                                        ...
                                        <p class="text">
                                            Kami yakin bahwa saat ini kami berada di posisi yang siap untuk mencapai
                                            visi dan misi perusahaan serta membangun landasan kokoh yang diperlukan
                                            untuk percepatan pertumbuhan bisnis pada tahun-tahun kedepan.
                    ...
                    <div class="container">
                        <div class="about_service_list client">
                            <h3>Visi Kami</h3>
                            <p>
                                “Menjadi Developer dan Kontraktor terkemuka di Indonesia yang memberi nilai tambah pada
                                stake holder yang peduli dengan Mu'amalah yang dihalalkan
